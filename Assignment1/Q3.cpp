...
public:
    ...
    void drawLine(GLfloat x1,GLfloat y1,GLfloat z1,GLfloat x2,GLfloat y2,GLfloat z2 ){
        ...
        void drawFractalLine(GLfloat x1,GLfloat y1,GLfloat z1,GLfloat x2,GLfloat y2,GLfloat z2)
        {
        ...
        void drawFractalLine(GLfloat x1,GLfloat y1,GLfloat z1,GLfloat len )
        {
            if(len>=1.0){
...
public:
    void drawCircle( GLfloat x, GLfloat y, GLfloat z, GLfloat radius, GLint no_of_sides){
    ...
    void drawFractalCircle1(GLfloat x, GLfloat y, GLfloat z,  GLfloat radius, GLint no_of_sides, float aspect_ratio){
    ...
    void drawFractalCircle2(GLfloat x, GLfloat y, GLfloat z,  GLfloat radius, GLint no_of_sides, float aspect_ratio){
        drawCircle(x,y,z,radius,36);
        if (radius >10){
    ...
    void drawFractalCircle(GLfloat x, GLfloat y, GLfloat z,  GLfloat radius, GLint no_of_sides,float aspect_ratio){
        drawCircle(x,y,z,radius,36);
        if (radius >8.0){
    ...
    void drawFractalCircle(GLfloat x, GLfloat y, GLfloat z,  GLfloat radius, GLint no_of_sides, float aspect_ratio, int option){
        if(option==1){
...
public:
    ...
    int start(int width, int height){
        ...
        //will draw and convert from normalised to pixels
