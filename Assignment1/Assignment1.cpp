...
public:
    ...
    std::vector<Point> drawFractalCircle(){
    	if(r>25){
    		cout << "Circle 0\n";
	    	std::vector<Point> points= drawCircle();
	    	for(auto i=points.begin();i!=points.end();i++)
	    	{
	    		cout << "IN1\n";
	    		Point &p=*i;
	    		points_in_circle.push_back(p);
	    	}
	    	//points_in_circle.insert(points_in_circle.end(), points.begin(), points.end());
	    	cout << points_in_circle.size() << '\n';
	    	cout << "Circle 1\n";
	    	Circle circle1(x1+r/2, y1, r/2);
	    	points= circle1.drawFractalCircle();
	    	for(auto i=points.begin();i!=points.end();i++)
	    	{
	    		cout << "IN2\n";
	    		Point &p=*i;
	    	...
	    	cout << points_in_circle.size() << '\n';
	    	cout << "Circle 2\n";
	    	Circle circle2(x1-r/2, y1, r/2);
	    	points= circle2.drawFractalCircle();
	    	for(auto i=points.begin();i!=points.end();i++)
	    	{
	    		Point &p=*i;
	    		points_in_circle.push_back(p);
	    	...
	    	cout << points_in_circle.size() << '\n';
	    	cout << "Circle 3\n";
	    	Circle circle3(x1, y1+r/2, r/2);
	    	points= circle3.drawFractalCircle();
	    	for(auto i=points.begin();i!=points.end();i++)
	    	{
	    		//cout << "IN3\n";
	    		Point &p=*i;
	    	...
	    	cout << points_in_circle.size() << '\n';
	    	cout << "Circle 4\n";
	    	Circle circle4(x1, y1-r/2, r/2);
			points= circle4.drawFractalCircle();
	    	for(auto i=points.begin();i!=points.end();i++)
	    	{
	    		//cout << "IN4\n";
	    		Point &p=*i;
